...
class TestPCA(unittest.TestCase):
    ...
    def test_get_min(self):
        ...
        self.assertRaises(ValueError, self.b._get_min, np.array([[1,1,1,1,1,1]]))
    ...
    def test_get_max(self):
        ...
        self.assertRaises(ValueError, self.b._get_max, np.array([[1,1,1,1,1,1]]))
    ...
    def test_rescale(self):
        ...
        self.assertRaises(ValueError, self.b._rescale_data, np.array([[1,1,1,1,1,1]]))
        ...
        np.testing.assert_array_almost_equal(maximum, np.array([self.gridResolution-1,self.gridResolution-1,self.gridResolution-1]), decimal=6)
